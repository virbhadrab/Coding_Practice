...
public class LoneAccount implements BankAccount{
	
	double accountBalance;
	long accountNumber;
	String accountHolderName;
	
	public LoneAccount(double accountBalance, long accountNumber, String accountHolderName) {
		super();
	...
	public void chechBalance() throws InterruptedException {
		System.out.println("Checkking Ammount From Account Number "+accountNumber);
		Thread.sleep(3000);
